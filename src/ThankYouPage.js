...
export default () => {
  ...
  const downloadUrl = "/Infonomics-ui.zip";
  React.useEffect(() => {
        ...
        <Content2Xl>
          ...
          <HeroRow>
            ...
            <div tw="mt-12 text-center">
              I am working on another library similar to Infonomics, with{" "}
              <span tw="font-bold">more components</span> and a much{" "}
              <span tw="font-bold">better developer experience</span>.
            </div>
            <div tw="mt-12 text-center">
              If you liked Infonomics and would like to get updates on the
